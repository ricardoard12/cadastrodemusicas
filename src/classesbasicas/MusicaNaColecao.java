...
public class MusicaNaColecao {
	...
	public Object clone() {
		...
		inst.nomeMusica = this.nomeMusica == null ? null : new String(
			this.nomeMusica);
		inst.letraMusica = this.letraMusica == null ? null : new String(
			this.letraMusica);
		inst.duracaoMusica = this.duracaoMusica;
		inst.observacaoMusica = this.observacaoMusica == null
			? null
			: new String(this.observacaoMusica);
		inst.nomeArquivoMusica = this.nomeArquivoMusica == null
			? null
			: new String(this.nomeArquivoMusica);
	...
	public int hashCode() {
		...
		hashCode = 31
			* hashCode
			+ (letraMusica == null ? 0 : letraMusica.hashCode());
		hashCode = 31 * hashCode + duracaoMusica;
		hashCode = 31
			* hashCode
			+ (observacaoMusica == null ? 0 : observacaoMusica.hashCode());
		hashCode = 31
			* hashCode
			+ (nomeArquivoMusica == null ? 0 : nomeArquivoMusica.hashCode());
