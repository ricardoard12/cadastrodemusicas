		...
		while (conexao == null) {
			...
			try {
				...
				try {
					...
					System.out.println("Atualizando o Banco de dados da Versão anterior à 1.0 para a Versão 1.3");
				...
				if (rs.getString("valor").equals("1.0")) {
					System.out.println("Atualizando o Banco de Dados da Versão 1.0 para a 1.3");
